...
# Loading pre-trained SVM model and scaler
...
# Adding Sidebar with user inputs
...
#Adding model information in sidebar
...
# Organizing input form into columns
